...
import {filenamesToSet, extractVersionNumber} from '../utils.js';
...
test('extractVersionNumber', () => {
    assert.equal(extractVersionNumber("Adyen Checkout API (v70)"), 70);
    assert.equal(extractVersionNumber("Adyen Checkout API (v1)"), 1);
    assert.equal(extractVersionNumber("Adyen Checkout API (v)"), null);
    assert.equal(extractVersionNumber("Adyen Checkout API"), null);
    assert.equal(extractVersionNumber("Adyen Checkout API (vPlop)"), null);
});
